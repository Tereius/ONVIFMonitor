...
public:
	...
	Q_INVOKABLE Uuid addDevice(const QUrl &rEndpoint, const QString &rUsername, const QString &rPassword, bool save = false ,const QString &rDeviceName = QString());
	Q_INVOKABLE Uuid addDevice(const QUrl &rEndpoint, const QString &rDeviceName = QString());
